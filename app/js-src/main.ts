...
document.addEventListener("DOMContentLoaded", function () {
  ...
  $("#pull-stoa").click(function(e) {
      if (this.classList.contains('pulled')) {
          ...
          this.innerText = 'pulling';
          let node = this.value;
          $("#stoa-iframe").html('<iframe id="stoa-iframe" name="embed_readwrite" src="/' + node + '" width="100%" height="500" frameborder="0"></iframe>');
          this.innerText = 'fold';
          this.classList.add('pulled');
      }
  });
  ...
  $(".pull-search").click(function(e) {
      if (this.classList.contains('pulled')) {
          ...
          this.innerText = 'pulling';
          let qstr = this.value;
          $.get('/fullsearch/' + qstr, function(data) {
